...
<div class="page">
  ...
  <div class="wrapper test">
    ...
    <div id="tabs">
      <ul>
        <li class="first"><a href="test_mysql.php"><span>MySQL</span></a></li>
        <li><a href="test_mssql.php"><span>MSSQL</span></a></li>
        <li><a href="test_msaccess.php"><span>MS Access</span></a></li>
        <li class="last" id="current"><a href="test_mail.php"><span>E-Mail</span></a></li>
      </ul>
    </div>
    <!-- MySQL server -->
